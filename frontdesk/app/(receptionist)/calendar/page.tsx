                ...
                <div className="px-5 pb-4 space-y-3 text-sm">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div className="space-y-1.5">
                            ...
                            <Input type="date" value={date} onChange={e => setDate(e.target.value)} className="rounded-xl text-sm h-9" />
                        </div>
                        <div className="space-y-1.5">
                            <label className="text-[11px] uppercase text-muted-foreground font-semibold block">Time</label>
                            <Input type="time" value={time} onChange={e => setTime(e.target.value)} className="rounded-xl text-sm h-9" />
                        </div>
                    </div>
                    <div className="space-y-1.5">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <Input placeholder="e.g. Patient requested earlier slot" value={reason} onChange={e => setReason(e.target.value)} className="rounded-xl text-sm h-9" />
                    </div>
                    {error && (
                            ...
                            <div className="flex-1 border-t border-border/40 relative flex flex-col">
                                ...
                                <div
                                    ...
                                    onDrop={(e) => {
                                        ...
                                        const id = e.dataTransfer.getData("sessionId");
                                        if (!id || !onSessionDrop) return;
                                        const d = new Date(date); d.setHours(h, 30, 0, 0);
                                        onSessionDrop(id, d.toISOString());
                                    }}
                                />
                            </div>
